...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/harshithakaredla/)
...
![Groq](https://img.shields.io/badge/Groq_LLaMA-F55036?style=for-the-badge&logo=meta&logoColor=white)
![RAG](https://img.shields.io/badge/RAG-0A66C2?style=for-the-badge&logo=databricks&logoColor=white)
...
- Built async **FastAPI** backend with session handling and metadata management
- Automated end-to-end AI workflows for document ingestion → retrieval → response generation
...
- Built high-concurrency **RESTful APIs** supporting distributed CRUD operations
- Architected scalable backend aligned with **SaaS development principles**
...
- Implemented **geo-tagged data tracking**, secure auth, and concurrent state synchronization
...
- 🤖 AI/ML open-source projects — especially RAG, agents, LLM tooling
- 🌐 Full-stack SaaS applications
- 🔬 Research projects in applied AI or backend systems
- 💡 Startup ideas at the intersection of AI and product engineering
